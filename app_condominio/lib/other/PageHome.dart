...
class MyHomePage extends StatelessWidget
{
    ...
    return Scaffold (
      appBar: AppBar(
        ...
        leading: CircleAvatar(
              ...
              child: Image( image: AssetImage('assets/Logo_Fondo_Transparente.png'), height: 50.0,), ),
      ...
      floatingActionButton: FloatingActionButton(
        ...
        child: Icon( Icons.call, semanticLabel: 'CALL',),
        elevation: 5.0,
        // foregroundColor: Colors.white70,
        onPressed: (){ _callCondominio(); },
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Container( 
            height: 40.0, 
            child: Center( 
              child: Text('${DataUser.getInstance().toString()}', 
                  style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14,color: Colors.white60 ),)
          ),),
        // elevation: 5.0,
        notchMargin: 5.0,
          ...
          switch (snapshot.connectionState) 
          {
            ...
            case ConnectionState.done:
              ...
              else
              {
                ...
                return snapshot.data ? PageSystem( imei: imei, ) : RegisterPage( imei: imei, );
              } 
          }
  ...
  {
    String getimei = await ImeiPlugin.getImei(shouldShowRequestPermissionRationale: false);
  ...
  {
    return showDialog<bool>( context: context, builder: _getBuilder, );
  }
  ...
  _getBuilder( BuildContext context )
  {
        return AlertDialog (
          ...
          title: Center( child: Text( 'Salir', style: TextStyle(color: Theme.of(context).primaryColor), ), ),
      ...
      SingleChildScrollView(
                   child: ListBody(
                    children: <Widget>[
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            Container( width: 100.0, 
                               child: RaisedButton( child: Container( child: Text('Cancelar'), ),
                      ...
                      Container( width: 100.0, child: RaisedButton(
                          child: Container(
                             child: Text('Salir'),
                           ),
                           shape: RoundedRectangleBorder( borderRadius: BorderRadius.circular(10.0)),
